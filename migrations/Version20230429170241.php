 ...
 */
final class Version20230429170241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservations (id_res INT AUTO_INCREMENT NOT NULL, id_event INT NOT NULL, Id_user INT NOT NULL, name VARCHAR(255) NOT NULL, dateRE DATE NOT NULL, PRIMARY KEY(id_res)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
